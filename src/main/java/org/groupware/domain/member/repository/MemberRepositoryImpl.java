...
public class MemberRepositoryImpl implements MemberRepository {
    ...
    public MemberEntity saveMember(Member member){
        ...
        // 권한 설정
        RoleEntity roleEntity = jpaRoleRepository.findByRoleName(member.getInfo().getRole()).orElseThrow(() -> new MemberException("존재하지 않는 권한"));
    ...
    public Member findMemberById(Long memberId){
        MemberEntity memberEntity = jpaMemberRepository.findById(memberId).orElseThrow(() -> new MemberException("존재하지 않는 사용자"));
